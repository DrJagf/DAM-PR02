...
public class FacturasController {
	...
	private static FacturasController instance;

	private FacturasController() {
	}

	public static FacturasController getInstance() {
		if (instance == null) {
			instance = new FacturasController();
		}
		return instance;
	}
	 ...
	 * @return 
	 */
	public Factura save(Factura fact) {
	 ...
	 */
	public void delete(Factura fact) {
